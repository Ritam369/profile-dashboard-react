...
const DashboardLayout = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="flex flex-col min-h-[calc(100vh-64px)] justify-center items-center py-8">
        {showProfilePage ? (
          ...
          <div className="w-full flex flex-col items-center justify-center">
            ...
            <div className="grid grid-cols-1 text-center md:grid-cols-2 gap-6 max-w-2xl w-full mx-auto mt-4">
              <div className="bg-white flex flex-col rounded-lg shadow-sm border border-gray-200 p-6">
